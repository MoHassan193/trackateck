...
import 'package:visit_man/view/visitCard/screens/visitCard/getActivityOnly/widget/createNewTask.dart';
import 'package:visit_man/view/visitCard/screens/visitCard/getActivityOnly/widget/taskDetailPage.dart';
...
class TaskOfVisit extends StatelessWidget {
  const TaskOfVisit({Key? key, required this.id}) : super(key: key);
final int id;
  @override
            ...
            child: BlocBuilder<ActivityCubit, ActivityState>(
              builder: (context, state) {
                if (state is ActivityLoading) {
                  ...
                  final tasks = state.activities.where((task) => task['res_id'] == id).toList();
                  final todayTasks = [];
                  final overcomeTasks = [];
                  final lastTasks = [];
                  ...
                  return DefaultTabController(
                    ...
                    child: Scaffold(
                      appBar: AppBar(
                        actions: [
                          IconButton(
                              onPressed: () => Move.move(context, CreateNewTaskOfVisit(id: id)),
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return GestureDetector(
            onTap: () => showDialog(
              context: context,
              builder: (context) => TaskDetailsPageOfVisit(
                id: id,
